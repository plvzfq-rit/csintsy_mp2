...
# @author Percy Liang
# Some modifications by Thomas Tiam-Lee
...
class KnowledgeBase:
    ...
    # Additional function to get all constants in the KB
    ...
    def addDerivation(self, deriv):
        ...
        if deriv.form == AtomFalse or universalInterpret(deriv.form) == AtomFalse: return False
