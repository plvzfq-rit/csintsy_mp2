...
% not_mother(X,Y) :- (\+ mother(X,Y); (mother(_,Y), \+ _ == X)).
...
% not_father(_,Y) :- (\+ father(X,Y); (father(_,Y), \+ _ == X)).
...
% not_parent(X,Y) :- nibling(X,Y). %
% not_parent(X,Y) :- grandchild(X,Y). %
...
% not_child(X,Y) :- nibling(X,Y).
% not_child(X,Y) :- grandchild(X,Y).
...
% not_sibling(X,Y) :- parent(X,Y).
% not_sibling(X,Y) :- child(X,Y).
% not_sibling(X,Y) :- grandparent(X,Y).
% not_sibling(X,Y) :- pibling(X,Y).
% not_sibling(X,Y) :- nibling(X,Y).
% not_sibling(X,Y) :- grandchild(X,Y).
...
% not_grandparent(X,Y) :- sibling(X,Y). %
% not_grandparent(X,Y) :- pibling(X,Y).
% not_grandparent(X,Y) :- nibling(X,Y). %
% not_grandparent(X,Y) :- grandchild(X,Y). %
...
% not_pibling(X,Y) :- grandchild(X,Y). %
